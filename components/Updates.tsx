...
const Updates = () : JSX.Element => {
  return (
    <section className="updates">
      ...
      <article>
        <h3>Fancams</h3>
        <p>Almost every tweet I see have different numbers when it gets updated because not all are fancams. To prevent that, I made this statistic based on criteria, see here.</p>
      </article>
      <article>
